...
public class SampleController implements Initializable {
    ...
    private  ObservableList<String> emailObservable = FXCollections.observableArrayList("angela.caicedo@oracle.com", "angela.caicedo@xxx.com", "angela.caicedo@vmm.com");
